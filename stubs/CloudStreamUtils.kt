...
class ExtractorLink(val source: String, val name: String, val url: String, val referer: String = "",
    val quality: Int = 0, val isM3u8: Boolean = false, val headers: Map<String, String> = emptyMap(),
...
class ExtractorLinkBuilder(val source: String, val name: String, val url: String, val type: ExtractorLinkType) {
    var referer: String = ""; var quality: Int = 0; var headers: Map<String, String> = emptyMap()
}

fun newExtractorLink(source: String, name: String, url: String,
    type: ExtractorLinkType = ExtractorLinkType.VIDEO, block: ExtractorLinkBuilder.() -> Unit = {}): ExtractorLink {
